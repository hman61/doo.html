    ...
    class Mock  {
        constructor(argArr, argCnt) {
            ...
            for (let i=0;i<argCnt;i++) {
                obj = {}
                let x = parseInt(Math.random()*1000, 10)
                obj.fname = fname[x % 2][x]
                obj.sex = x % 2 ? 'M' : 'F'
                obj.lname = lname[parseInt(Math.random()*100, 10)];
